...
//for Preloader
    ...
    var timeFirst  = new Date("December 17, 2018 10:00:00");
    var timeSecond = new Date();
    var differenceInSeconds = (timeFirst.getTime() - timeSecond.getTime())/1000;
    var timer = differenceInSeconds;
    ...
    xhttp.onreadystatechange = function() {
     if (this.readyState == 4 && this.status == 200) {
         document.getElementById("commit-counter").innerHTML = "Total Commits - "+this.responseText;
     }
    };
    xhttp.open("GET", "commit_counter.txt", true);
    xhttp.send();
